...
class AltaInvitadoIngreso extends Component {
    constructor(props) {
        super(props);
        this.state = {
            grupo: '',
    ...
    FormInvalid() {
        ...
        let invalid = (this.state.errorDesde.error || this.state.errorHasta.error ||
            this.errorDocumentoInvitado.error || this.errorNombre.error || this.errorApellido.error ||
    ...
    render() {
        return (
            <div className={this.state.loading ? "col-12 form" : "col-12"}>
                <legend>
                    <h3 className="row">Ingreso - Nuevo Invitado</h3>
                </legend>
                <div className="row card">
                    <div className="card-body">
                        <h5 className="row">Buscar Propietario</h5>
                        <legend/>
...
export default AltaInvitadoIngreso;
